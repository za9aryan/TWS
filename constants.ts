...
export const ServicesData: IServices[] = [
    ...
    //     description: "Descritpion",
    //     icon: false,
    //     checkBoxes: ["Duis aute irure", "Excepteur sint occaecat", "Amet consectetur adipiscing eli"]
    // },
    // {
    //     title: "Service 2",
    //     description: "Descritpion",
...
export const testimonalsTitle = "Benefits"
export const testimonalsDescription = "Partner with TestWare Solutions to supercharge your software quality, reduce time-to-market, and enhance the user experience. Let's turn your software into a competitive advantage!"
