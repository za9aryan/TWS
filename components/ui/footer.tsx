        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1">
                    <Link href="/#OurSolutions" className="text-gray-400 hover:text-primary-greenHover transition duration-150 ease-in-out">Our Solutions</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/#howWeDoIt" className="text-gray-400 hover:text-primary-greenHover transition duration-150 ease-in-out">How We Do It</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/#benefits" className="text-gray-400 hover:text-primary-greenHover transition duration-150 ease-in-out">Benefits</Link>
                  </li>
                  <li className="mb-1">
                    <Link href="/#contact" className="text-gray-400 hover:text-primary-greenHover transition duration-150 ease-in-out">Contact Us</Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              ...
              {/* <li className="ml-4">
                <Link href="/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Cuntact Us">
                  <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="/" className="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Cuntact Us">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 3.75v4.5m0-4.5h-4.5m4.5 0l-6 6m3 12c-8.284 0-15-6.716-15-15V4.5A2.25 2.25 0 014.5 2.25h1.372c.516 0 .966.351 1.091.852l1.106 4.423c.11.44-.054.902-.417 1.173l-1.293.97a1.062 1.062 0 00-.38 1.21 12.035 12.035 0 007.143 7.143c.441.162.928-.004 1.21-.38l.97-1.293a1.125 1.125 0 011.173-.417l4.423 1.106c.5.125.852.575.852 1.091V19.5a2.25 2.25 0 01-2.25 2.25h-2.25z" />
                </svg>
              </Link>
              </li> */}
            </ul>
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; testwaresolutions.com. © 2023 . All rights reserved.</div>
