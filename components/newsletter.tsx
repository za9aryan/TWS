      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative bg-primary-gray py-10 px-8 md:py-16 md:px-12" data-aos="fade-up">
            ...
            <svg width="238" height="110" fill="none" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="illustration-04" x1="369.483" y1="-84.633" x2="139.954" y2="-199.798" gradientUnits="userSpaceOnUse">
                  ...
                  <stop offset="1" stopColor="#5dc300" stopOpacity=".24" />
                </linearGradient>
              </defs>
          ...
          <div className="text-center mb-3">
            <h3 className="h3 text-white mb-2">Write To Us</h3>
            <p className="text-purple-200 text-center text-lg">Join our Linkedin to get top news before anyone else..</p>
          </div>
          <div className="relative flex flex-col lg:flex-row justify-between items-start">

            {/* CTA content */}
            <div className="mb-6 mt-6 lg:mr-16 lg:mb-0 items-center flex flex-col text-center lg:text-left lg:w-1/2">
              
              <iframe className=" hidden lg:block" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3047.4176013303772!2d44.48883197521692!3d40.199772768816814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406abd6bbf260be5%3A0xfcd60dca516cdb29!2sYerevan%20Mergelyan%20Scientific%20Research%20Institute%20of%20Mathematical%20Machines!5e0!3m2!1sru!2sam!4v1699119487347!5m2!1sru!2sam" width="100%" height="365" style={{border:0}} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
