...
export default function Features() {
  ...
  const svgIcon = <><svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
    <rect className="fill-current text-primary-green" width="64" height="64" rx="32" />
  ...
  //   {
  //     title: "some title",
  //     description: "lkajdlkawd alwkdjlkawjdla wd",
  //     icon: svgIcon
  //   }
  // ]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">{FeatureTitle}</h2>
            <p className="text-xl text-gray-400">{FeatureDescription}</p>
          </div>
